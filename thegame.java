...
class thegame {
    public static void main(String[] args) {
        ...
        String [] weaponry1 = {"sword basic", "sword standard","sword elite"};
        String [] weaponry2 = {"staff basic", "staff standard","staff elite"};
 

        String [] potions = {"low potion","mid potion","high potion"};
